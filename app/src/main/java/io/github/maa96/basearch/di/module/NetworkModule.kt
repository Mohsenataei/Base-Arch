...
import io.github.maa96.data.di.qualifier.WithToken
import io.github.maa96.data.di.qualifier.WithoutToken
...
//                    )
    ...
    @Provides
    @Concrete
    fun provideConcreteCryptoDataSource(@WithoutToken retrofit: Retrofit): DataSource {
        return retrofit.create(DataSource::class.java)
    }

    @Provides
    @Stub
    fun provideStubCryptoDataSource(gson: Gson, fileProvider: BaseFileProvider): DataSource {
        return StubDataSource(gson, fileProvider)
    }
}
